...
class Scanner(sourceFile : File, private val errorHandler : ErrorHandler)
  {
    ...
    init
      {
        val fileReader = FileReader(sourceFile, StandardCharsets.UTF_8)
    ...
    private fun scanIdentifier() : String
      {
        ...
        while (CharUtil.isLetterOrDigit(source.currentChar.toChar()))
    ...
    private fun getIdentifierSymbol(idString : String) : Symbol
        = opcodeMap.getOrDefault(idString.uppercase(), Symbol.identifier)
