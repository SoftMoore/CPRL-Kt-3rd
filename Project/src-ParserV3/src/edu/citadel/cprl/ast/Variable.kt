...
// ...
                    ...
                    if (recType.containsField(fieldId.text))
                      {
                        val fieldDecl : FieldDecl? = recType[fieldId.text]

                        // fieldDecl should not be null at this point
                        if (fieldDecl != null)
                          {
                  ...
                  {
                    val errorMsg = ("Selector expression not allowed for variable of type $type")
                    throw error(expr.position, errorMsg)
                  }
              }
          }
